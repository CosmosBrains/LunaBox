...
export class CustomScalePrompt {
    constructor(_doc) {
        ...
        this.container = div({ class: "prompt noSelection", style: "width: 250px;" }, div({ class: "promptTitle" }, h2({ class: "sclaeExt", style: "text-align: inherit;" }, ""), h2({ class: "scaleTitle" }, "Custom Scale")), div({ style: "display: flex; flex-direction: row; align-items: center; justify-content: flex-end;" }, scaleHolder), div({ style: "display: flex; flex-direction: row-reverse; justify-content: space-between;" }, this._okayButton), this._cancelButton);
